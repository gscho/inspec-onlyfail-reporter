...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'inspec-onlyfail-reporter'

  # It is polite to namespace your plugin under InspecPlugins::YourPluginInCamelCase
  spec.version       = InspecPlugins::OnlyfailReporter::VERSION
  spec.authors       = ['Greg Schofield']
  spec.email         = ['greg.c.schofield@gmail.com']
  spec.summary       = 'An inspec reporter that only displays failed controls'
  spec.description   = ''
  spec.homepage      = 'https://github.com/gscho/inspec-onlyfail-reporter'
  ...
  # out tests, etc)
  spec.files = %w{
    README.md inspec_onlyfail_reporter.gemspec Gemfile
  } + Dir.glob(
